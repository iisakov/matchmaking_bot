...
var RowQuestion = map[string]map[string][]string{
	...
	"Через какое время вы ответите на сообщение вашего партнера?": {
		"answers": {"сразу же", "когда закончу свои дела/работу", "не буду отвечать - перезвоню", "если важно отвечу сразу, если нет - отложу"},
		"options": {"onlyOne"}},
	"Кто в вашем доме занимался домашними обязанностями": {
